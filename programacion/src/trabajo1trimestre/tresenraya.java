			...
			public static void main(String[] args) {
				...
				do { 
					...
					case 1:
						...
						//para que empate funcione tiene q no ganar jugador 1 ni jugador 2 y no quedar casillas
						if ((ganaJugador1()==false)&&(ganaJugador2()==false)){
							System.out.println("Ohhhhh vaya habeis empatado,volver a intentarlo jugando otra partida");
							empate++;
						}
